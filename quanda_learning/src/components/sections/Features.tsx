...
export default function Features() {
  const features = [
    {
      ...
      desc: "AI accurately assesses your current proficiency to build a personalized learning path.",
    ...
    },
    {
      ...
      desc: "Receive detailed feedback and improvement suggestions after each test.",
  ...
  return (
    <section id="tinh-nang" className="bg-white rounded-lg shadow-lg p-10 mx-auto space-y-8">
      ...
      <div className="flex flex-col md:flex-row items-start gap-10 max-w-7xl mx-auto px-4 py-12">
        ...
        <div className="md:w-1/2">
          <img id="backgAI" src='https://png.pngtree.com/thumb_back/fw800/background/20250506/pngtree-ai-and-technology-shaping-the-future-of-innovation-image_17241997.jpg' />

          <p id='descAI' className="text-gray-700 text-lg text-justify">
            Our AI-powered learning system personalizes your journey by analyzing your strengths and weaknesses, then delivering exercises tailored to your skill level.
          </p>
        </div>
          ...
          <div className="grid grid-cols-1 gap-8">
            {features.map((f, i) => (
              <div key={i} className="flex items-start gap-8">
                {/* Image bên trái */}
                <img id="imageAI" src={f.img} alt={f.title} className="h-28 w-28 flex-shrink-0" />
